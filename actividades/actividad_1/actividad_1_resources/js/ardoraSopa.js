...
var title="Palabra";
context.font = "15px "+fActi;var widthWords=context.measureText(title).width+20;
...
function paintList(context){var title="Palabra";context.font = "15px "+fActi;var widthWords=context.measureText(title).width+20;
